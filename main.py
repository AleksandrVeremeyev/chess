...
def main():
    ...
    player_clicks = [] # сохранение выбранных клеток
...
def draw_board(screen, _gs, row, col):
    ...
    if sq_bool:
        ...
        s.set_alpha(200)
        s.fill(p.Color("blue"))
        screen.blit(s, (sq_col * SQ_SIZE, sq_row * SQ_SIZE))
            ...
            if n != False:
                for i in n:
                    if i[0] == 'get':
                        ...
                        screen.blit(s, (i[2] * SQ_SIZE, i[1] * SQ_SIZE))
                    elif i[0] == 'att':
            ...
            if n != False:
                for i in n:
                    if i[0] == 'get':
                        ...
                        #p.draw.rect(screen, p.Color("yellow"), p.Rect(i[2] * SQ_SIZE, i[1] * SQ_SIZE, SQ_SIZE, SQ_SIZE))
                        s = p.Surface((SQ_SIZE, SQ_SIZE))
                        s.set_alpha(100)
