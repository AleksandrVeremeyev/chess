class Game:
    ...
    def make(self, startRow, startCol, endRow, endCol, pieceMoved, pieceCaptured, castling_r=False):
        ...
        if castling_r:
            self.moveLog.append([startRow, startCol, endRow, endCol, pieceMoved, pieceCaptured, castling_r])
        else:
            self.moveLog.append([startRow, startCol, endRow, endCol, pieceMoved, pieceCaptured, False])
